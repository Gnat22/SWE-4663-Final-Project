            ...
            <form onSubmit={handleSignUp} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-slate-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                />
              </div>
